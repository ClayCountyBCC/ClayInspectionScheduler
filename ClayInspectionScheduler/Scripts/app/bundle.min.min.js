function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}function _classCallCheck(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function");}var XHR,InspSched,_createClass;(function(n){var i,t;(function(n){n[n.no_access=0]="no_access";n[n.public_access=1]="public_access";n[n.basic_access=2]="basic_access";n[n.inspector_access=3]="inspector_access"})(i=n.access_type||(n.access_type={}));t=function(){function n(){}return n}();n.Permit=t})(InspSched||(InspSched={})),function(n){var t=function(){function n(n){var i,t,r;for(this.Permit="",i=n.split("&"),t=0;t<i.length;t++){r=i[t].split("=");switch(r[0].toLowerCase()){case"permit":this.Permit=r[1]}}}return n.prototype.update=function(n){var t="";return n.length>0&&(t+="&permit="+n),t.substring(1)},n}();n.LocationHash=t}(InspSched||(InspSched={})),function(n){var t=function(){function n(n,t,i,r){this.PermitNo=n;this.InspectionCd=t;this.SchecDateTime=i;this.Comment=r}return n}();n.NewInspection=t}(InspSched||(InspSched={})),function(n){var t;(function(t){"use strict";function p(n){r(document.getElementById("SearchFailed"));i("PermitSelectContainer");i("CurrentPermitData");i("CurrentPermit");i("InspectionTable");i("SearchFailed");i("SuspendedContractor");i("NotScheduled");f("Searching");var t=n.trim().toUpperCase();return document.getElementById("PermitSearch").setAttribute("value",t),t.length!=8||isNaN(Number(t))?(i("Searching"),y(n),null):t}function w(n,t){n.length==0?y(t):(b(n,t),e(t,n),i("Searching"),document.getElementById("CurrentPermitData").style.display="block",g(t,n))}function b(n,t){var f=document.getElementById("PermitSelect"),e,c,u,l,i;for(r(f),e=o("Search Results","current"),c=o("Related Permits","related"),f.appendChild(e),n.length>1&&f.appendChild(c),u=0,l=n;u<l.length;u++)i=l[u],i.PermitNo==t?(e.appendChild(s(i,t)),h(t,i)):n.length>1&&c.appendChild(s(i,t))}function e(t){var o=document.getElementById("ProjAddrCombined"),s=document.getElementById("ProjCity"),i,u,e;r(o);r(s);i=n.CurrentPermits.filter(function(n){return n.PermitNo===t})[0];i.Supervisor_URL.length>0?(u=document.createElement("a"),u.style.textDecoration="underline",u.href=i.Supervisor_URL,u.appendChild(document.createTextNode(i.ProjAddrCombined.trim())),e=document.createElement("a"),e.style.textDecoration="underline",e.href=i.Supervisor_URL,e.appendChild(document.createTextNode(i.ProjCity.trim())),o.appendChild(u),s.appendChild(e)):(o.appendChild(document.createTextNode(i.ProjAddrCombined.trim())),s.appendChild(document.createTextNode(i.ProjCity.trim())));f("PermitSelectContainer")}function o(n,t){var i=document.createElement("optgroup");return i.label=n,i.value=t,i}function s(n,t){var r=v(n.PermitNo[0]),i=document.createElement("option");return i.setAttribute("value",n.PermitNo.trim()),i.setAttribute("label",n.PermitNo+"  ("+r+")"),i.setAttribute("title",n.PermitNo.trim()),i.appendChild(document.createTextNode(n.PermitNo+"  ("+r+")")),i.id="select_"+n.PermitNo,n.PermitNo==t?(i.value=n.PermitNo.trim(),i.selected=!0):i.value=n.PermitNo.trim(),i}function h(t,u){var f,e,o;document.getElementById("InspectionScheduler").removeAttribute("value");f=document.getElementById("SaveSchedule");f!=undefined&&(f.setAttribute("disabled","disabled"),f.removeAttribute("value"));e=0;o=!0;i("InspSched");i("InspListHeader");i("InspListData");i("SuspendedContractor");r(document.getElementById("InspListData"));n.transport.GetInspections(t).then(function(i){return i.length>0?(n.CurrentInspections=i,c(n.CurrentInspections,u)):(document.getElementById("NoInspections").style.display="flex",document.getElementById("InspSched").style.display="flex",document.getElementById("PermitScreen").style.display="flex"),l(n.CurrentInspections,t),!0},function(){return console.log("error getting inspections"),!1})}function c(t,i){var e=document.getElementById("InspListData"),o=document.createElement("tr"),r,u,f;for(console.log("inspections",t),r=0,u=t;r<u.length;r++)f=u[r],i.access===n.access_type.public_access&&(f.Comment=""),e.appendChild(k(f));e.style.removeProperty("display");document.getElementById("InspSched").style.removeProperty("display");document.getElementById("PermitScreen").style.display="flex"}function k(t){var f=n.CurrentPermits.filter(function(n){return n.PermitNo===t.PermitNo})[0],bt=t.InspReqID.toString()+"_comments",e=document.createElement("div"),nt,o,it,rt,v,ut,s,y,h,ot,st,r,p,ft,ht,ct,lt,w,b,c,k,i,l,et,g,at,vt,yt,pt,a,wt;return e.setAttribute("elementName","inspRow"),t.ResultADC.length==0?e.className="InspRow large-12 medium-12 small-12 row flex-container align-middle":t.ResultADC=="A"||t.ResultADC=="P"?e.className="InspRow large-12 medium-12 small-12 row flex-container align-middle PassRow":t.ResultADC=="C"?e.className="InspRow large-12 medium-12 small-12 row flex-container align-middle CancelRow":(t.ResultADC=="F"||t.ResultADC=="D"||t.ResultADC=="N")&&(e.className="InspRow large-12 medium-12 small-12 row flex-container align-middle FailRow"),nt=document.createElement("div"),nt.className="large-12 medium-12 small-12 row flex-container align-middle",nt.setAttribute("elementName","dataColumn"),o=document.createElement("div"),o.setAttribute("elementName","inspectionData"),o.className="large-10 medium-8 small-12",it=document.createElement("div"),it.className="large-2 medium-6 small-6 column InspPermit ",it.setAttribute("elementName","permitNumber"),rt=document.createElement("div"),rt.className="large-5 medium-6 small-6 InspType column",rt.setAttribute("elementName","inspDesc"),rt.appendChild(document.createTextNode(t.InsDesc.trim())),v=document.createElement("div"),v.className="large-2 medium-6 small-6 column InspDate",v.setAttribute("elementName","inspDateTime"),ut=document.createElement("div"),ut.className="large-3 medium-6 small-12 InspResult column end",ut.setAttribute("elementName","inspector"),ut.appendChild(document.createTextNode(t.InspectorName.trim())),s=document.createElement("div"),s.setAttribute("elementName","InspButtonDiv"),s.className="ButtonContainer row large-2 medium-4 small-12 flex-container align-center",y=document.createElement("div"),y.className="large-12 medium-12 small-12 row flex-container align-middle details-container",y.setAttribute("elementName","DetailsSection"),h=document.createElement("div"),h.setAttribute("elementName","CompletedRemarks"),h.className="large-10 medium-12 small-12 ",h.id=t.InspReqID.toString()+"_completed_remark",h.style.display="flex",ot=document.createElement("div"),ot.className="column large-9 medium-8 small-12 inspRemarks",ot.setAttribute("elementName","Remark"),ot.appendChild(document.createTextNode(t.Remarks!==null&&t.Remarks!==""?t.Remarks.trim():"")),st=document.createElement("div"),st.setAttribute("elementName","ResultADC"),st.className="large-3 medium-4 small-12 InspResult column large-text-left text-center end ",st.appendChild(document.createTextNode(t.ResultDescription.trim())),r=document.createElement("div"),r.setAttribute("elementName","addRemarkContainer"),r.className="large-12 medium-12 small-12 row flex-container align-middle add-remark-container",r.id=t.InspReqID+"_add_remark",r.style.display="none",p=document.createElement("div"),p.setAttribute("elementName","addRemark"),p.className="row large-12 medium-12 small-12 flex-container flex-child-grow",ft=document.createElement("label"),ft.setAttribute("elementName","addRemarkLabel"),ft.className="large-12 medium-12 small-12 row ",ft.textContent="Public Remarks:",ft.style.textAlign="left",ht=document.createElement("div"),ht.className="large-10 medium-8 small-12 flex-dir-row",ht.style.paddingLeft="1em",ct=document.createElement("textarea"),ct.setAttribute("elementName","remarkTextarea"),ct.className="remark-text",ct.rows=1,lt=document.createElement("div"),lt.setAttribute("elementName","addRemarkButtonDiv"),lt.className="ButtonContainer column large-2 medium-4 small-12 flex-container align-center flex-child-grow",w=document.createElement("button"),w.setAttribute("elementName","addRemarkButton"),w.className="align-self-center columns DetailsButton large-12 medium-12-small-12",w.setAttribute("onclick","transport.SaveInspectionResult(inspection)"),w.style.margin="0",w.textContent="Save Result",b=document.createElement("div"),b.setAttribute("elementName","radioButtonSection"),b.className="large-12 medium-12 small-12 column",b.style.paddingLeft="1em",b.appendChild(d(t.ResultADC,f.access,0)),c=document.createElement("div"),c.className="large-12 medium-12 small-12 row flex-container comment-container",c.setAttribute("elementName","CommentContainer"),c.style.display="none",c.id=t.InspReqID+"_comments",k=document.createElement("div"),k.setAttribute("elementName","textboxdiv"),k.className="large-12 medium-12 small-12 row",k.style.display="flex",i=document.createElement("textarea"),i.setAttribute("elementName","thiscomment"),i.className="row large-12 medium-12 small-12 No-Edit completed-comments-textarea",i.rows=4,l=document.createElement("div"),l.setAttribute("elementName","AddCommentDiv"),l.className="row large-12 medium-12 small-12 flex-container flex-child-grow",l.style.paddingLeft="1em",et=document.createElement("label"),et.setAttribute("elementName","commentlabel"),et.className="large-12 medium-12 small-12 row ",et.style.textAlign="left",et.innerText="Add Comments:",g=document.createElement("textarea"),g.setAttribute("elementName","AddCommentTextarea"),g.className="large-10 medium-10 small-12 flex-dir-row Comment-Textarea",g.style.resize="none",g.rows=3,g.maxLength=200,at=document.createElement("div"),at.setAttribute("elementName","SaveCommentuttonDiv"),at.className="ButtonContainer row large-2 medium-2 small-12 flex-container align-center",vt=document.createElement("button"),vt.className="align-self-center columns SaveCommentButton",vt.setAttribute("elementName","SaveCommentButton"),vt.textContent="Save Comment",f.access!==n.access_type.public_access?(yt=document.createElement("a"),yt.style.textDecoration="underline",yt.href=f.Permit_URL,yt.appendChild(document.createTextNode(t.PermitNo)),it.appendChild(yt)):it.appendChild(document.createTextNode(t.PermitNo)),t.DisplayInspDateTime.toLowerCase()=="incomplete"?v.appendChild(document.createTextNode(t.DisplaySchedDateTime)):v.appendChild(document.createTextNode(t.DisplayInspDateTime)),o.appendChild(it),o.appendChild(v),o.appendChild(rt),o.appendChild(ut),nt.appendChild(o),ht.appendChild(ct),lt.appendChild(w),p.appendChild(ft),p.appendChild(ht),p.appendChild(lt),r.appendChild(p),r.appendChild(b),e.appendChild(nt),t.ResultADC.length>0||t.DisplaySchedDateTime.length===0?(a=u(t.InspReqID+"_details_btn","Details","InspSched.UI.ToggleInspDetails(this.value)",t.InspReqID),a.className="column large-12 medium-12 small-12 align-self-center NewInspButton DetailsButton",pt="CreateNew_"+t.PermitNo,document.getElementById(pt)||f.ErrorText.length!==0?a.style.margin="0":s.appendChild(u(pt,"New","InspSched.UpdatePermitSelectList('"+t.PermitNo+"');")),s.appendChild(a)):t.ResultADC.length==0&&(a=u(t.InspReqID+"_details_btn","Details","InspSched.UI.ToggleInspDetails(this.value)",t.InspReqID),tt(t,n.ThisPermit.access)&&(f.access===n.access_type.public_access?(wt=f.ErrorText.substr(2,16).toLowerCase(),wt!="private provider"&&(s.appendChild(u("","Cancel","InspSched.CancelInspection('"+t.InspReqID+"', '"+t.PermitNo+"');")),a.className="column large-12 medium-12 small-12 align-self-center NewInspButton DetailsButton")):a.style.margin="0",s.appendChild(a))),nt.appendChild(s),t.DisplayInspDateTime.length>0&&(t.InspReqID!=="99999999"?(h.appendChild(ot),h.appendChild(st),y.appendChild(h)):(ut.style.display="none",v.style.display="none",rt.className="large-10 medium-6 small-6 InspType InspResult column")),t.Comment.length>0&&(i.textContent=t.Comment,i.readOnly=!0,i.contentEditable="false",i.style.margin="0",i.style.overflowY="scroll",i.style.display="flex",k.appendChild(i),k.style.display="flex",c.appendChild(k)),l.appendChild(et),l.appendChild(g),at.appendChild(vt),l.appendChild(at),c.appendChild(l),(f.access===n.access_type.basic_access||f.access===n.access_type.inspector_access)&&(y.appendChild(r),r.appendChild(b),y.appendChild(c)),e.appendChild(y),e}function u(n,t,i,r){var u=document.createElement("button");return u.id=n,u.value="",u.className="align-self-center columns NewInspButton",u.appendChild(document.createTextNode(t)),u.setAttribute("onclick",i),u.value=r==null?"":r,u}function d(t,i,r){var a=document.createElement("input"),o,c,s,l,h,u,f,e;return a.id=(r>0?"perform":"approve")+"_selection",a.type="radio",a.value=r>0?"P":"A",o=document.createElement("label"),o.className="columns",o.htmlFor="approve_selection",o.appendChild(a),o.appendChild(document.createTextNode(r>0?"Perform":"Approve")),c=document.createElement("input"),c.id=(r>0?"not_performed":"disapprove")+"_selection",c.type="radio",c.value=r>0?"N":"D",s=document.createElement("label"),s.className="columns",s.htmlFor="disapprove_selection",s.appendChild(c),s.appendChild(document.createTextNode(r>0?"not_performed":"disapprove")),l=document.createElement("input"),l.id="cancelradio_selection",l.type="radio",l.value="C",h=document.createElement("label"),h.className="columns",h.htmlFor="cancel_selection",h.appendChild(l),h.appendChild(document.createTextNode("Cancel")),u=document.createElement("input"),u.id="incompleteradio_selection",u.type="radio",u.value="",u.textContent="Incomplete",f=document.createElement("label"),f.className="columns",f.htmlFor="incomplete_selection",f.appendChild(u),f.appendChild(document.createTextNode("Incomplete")),e=document.createElement("div"),e.className="large-10 medium-10 small-12 flex-container flex-dir-row flex-child-grow align-justify",e.appendChild(o),e.appendChild(s),e.appendChild(h),e.appendChild(f),i==n.access_type.inspector_access&&f.appendChild(u),e}function l(t,i){a(i);n.BuildCalendar(n.ThisPermit.ScheduleDates,n.ThisPermit.ErrorText);document.getElementById("InspectionScheduler").setAttribute("value",i)}function a(t){var o=t[0],a=v(o),s=document.getElementById("InspTypeSelect"),u=document.createElement("option"),c,l,e,h,f,i;for(r(s),u.appendChild(document.createTextNode(a+" Inspections:")),u.className="selectPlaceholder",u.selected,u.value="",s.appendChild(u),c=n.CurrentPermits.filter(function(n){return n.PermitNo===t})[0],l=n.InspectionTypes.filter(function(n){if(n.InspCd[0]===o)return c.NoFinalInspections?!n.Final:!0}),e=0,h=l;e<h.length;e++)f=h[e],f.InspCd[0]==o&&(i=document.createElement("option"),i.label=f.InsDesc,i.value=f.InspCd,i.className="TypeSelectOption",i.appendChild(document.createTextNode(f.InsDesc)),s.appendChild(i))}function v(n){switch(n){case"1":case"0":case"9":return"Building";case"2":return"Electrical";case"3":return"Plumbing";case"4":return"Mechanical";case"6":return"Fire";default:return"Unknown"}}function f(n,t,i){var r;t?(r=document.getElementById(n),t.style.display=i==null?"block":i):(r=document.getElementById(n),r.style.display!=null&&(r.style.display=i==null?"block":i))}function i(n){var t=document.getElementById(n);t&&(t.style.display="none")}function r(n){while(n.firstChild)n.removeChild(n.firstChild)}function g(n,t){var r=document.getElementById("InspectionTable");t&&(i("Searching"),r.style.removeProperty("display"))}function y(n){var u=document.getElementById("SearchFailed"),t;r(u);t=document.createElement("h3");isNaN(Number(n))||n.length!=8?t.innerHTML=!isNaN(Number(n))&&n.length>0&&n.length!=8?'"'+n+'" is not a valid Permit Number':n.length==0?"You did not enter any information.<br />Enter a valid permit number and click search.":"Invalid Entry<br />":t.appendChild(document.createTextNode("Permit #"+n+" not found"));t.style.textAlign="center";u.appendChild(t);i("Searching");f("SearchFailed")}function nt(n,t){var f,e,o,u;i("InspectionScheduler");r(document.getElementById("InspTypeSelect"));f=document.getElementById("Reasons");r(f);e=document.getElementById("ErrorHeading");r(e);o=document.createElement("ul");u=document.createElement("li");e.appendChild(document.createTextNode("The following issue is preventing the ability to schedule an inspection:"));u.appendChild(document.createTextNode(t));u.style.marginLeft="2rem;";o.appendChild(u);f.appendChild(o);document.getElementById("NotScheduled").style.display="flex"}function tt(t,i){var r=new Date,u=new Date(t.DisplaySchedDateTime),f=r.getDate()+1;return u<r&&(i==n.access_type.no_access||i==n.access_type.public_access)?!1:!0}function it(t){if(n.UI.CurrentDetailsOpen!=""&&t!=n.UI.CurrentDetailsOpen){var o=document.getElementById(n.UI.CurrentDetailsOpen+"_add_remark"),f=document.getElementById(n.UI.CurrentDetailsOpen+"_completed_remark"),s=document.getElementById(n.UI.CurrentDetailsOpen+"_comments");o.style.display="none";s.style.display="none";f!=null&&(f.style.display="flex");document.getElementById(n.UI.CurrentDetailsOpen+"_details_btn").textContent="Details"}var i=document.getElementById(t.valueOf()+"_add_remark"),u=document.getElementById(t.valueOf()+"_completed_remark"),e=document.getElementById(t.valueOf()+"_comments"),h=document.getElementById(t.valueOf()+"_details_btn"),r=i.style.display.toString();console.log("addRemark visible?: "+r);u!=null&&(u.style.display=r=="flex"?"flex":"none",console.log("details visibility changed to: "+u.style.display.toString()));i.style.display=r=="none"?"flex":"none";console.log("add remark visibility changed to: "+i.style.display.toString());e.style.display=r=="none"?"flex":"none";console.log("comments visibility changed to: "+e.style.display.toString());document.getElementById(t.valueOf()+"_details_btn").textContent=(i.style.display.toString().toLowerCase()=="none"?"":"Hide ")+"Details";n.UI.CurrentDetailsOpen=t}t.CurrentPermits=[];t.CurrentInspections=[];t.PermitsWithOutInsp=[];t.CurrentDetailsOpen="";t.Search=p;t.ProcessResults=w;t.UpdatePermitData=e;t.GetInspList=h;t.BuildInspectionList=c;t.BuildScheduler=l;t.LoadInspTypeSelect=a;t.Show=f;t.Hide=i;t.clearElement=r;t.InformUserOfError=nt;t.ToggleInspDetails=it})(t=n.UI||(n.UI={}))}(InspSched||(InspSched={})),function(n){function u(n){var t=new r;return t.Headers=n.getAllResponseHeaders(),t.Text=n.responseText,t.Type=n.responseType,t.Status=n.status,t.StatusText=n.statusText,t}function t(n,t,i,r){return r===void 0&&(r=""),new Promise(function(f,e){var o=new XMLHttpRequest;o.open(n,t);i!=null&&i.forEach(function(n){return o.setRequestHeader(n.header,n.data)});o.onload=function(){(o.status<200||o.status>=300)&&e(u(o));f(u(o))};o.onerror=function(){e("Error "+n.toUpperCase()+'ing data to url "'+t+'", check that it exists and is accessible')};r.length>0?o.send(r):o.send()})}function i(t){return t===null||t.length==0?t=[new n.Header("Content-Type","application/json; charset=utf-8"),new n.Header("Accept","application/json")]:(t.push(new n.Header("Content-Type","application/json; charset=utf-8")),t.push(new n.Header("Accept","application/json"))),t}function f(n,r,u){return r===void 0&&(r=null),u===void 0&&(u=!0),r=u?i(r):r,t("GET",n,r)}function e(n,r,u,f){return r===void 0&&(r=""),u===void 0&&(u=null),f===void 0&&(f=!0),u=f?i(u):u,t("POST",n,u,r)}function o(n,r,u,f){return r===void 0&&(r=""),u===void 0&&(u=null),f===void 0&&(f=!0),u=f?i(u):u,t("PUT",n,u,r)}function s(n,r,u,f){return r===void 0&&(r=""),u===void 0&&(u=null),f===void 0&&(f=!0),u=f?i(u):u,t("DELETE",n,u,r)}var h=function(){function n(n,t){this.header=n;this.data=t}return n}(),r;n.Header=h;r=function(){function n(){}return n}();n.Data=r;n.Get=f;n.Post=e;n.Put=o;n.Delete=s}(XHR||(XHR={})),function(n){var t;(function(t){"use strict";function i(n){var t=XHR.Get("API/Permit/"+n);return new Promise(function(n,i){t.then(function(t){var i=JSON.parse(t.Text);n(i)}).catch(function(){console.log("error in GetPermit");i(null)})})}function r(){var n=XHR.Get("API/InspType/");return new Promise(function(t,i){n.then(function(n){var i=JSON.parse(n.Text);t(i)}).catch(function(){console.log("error in GetInspTypeList");i(null)})})}function u(n){var t=XHR.Get("API/Inspection/"+n);return new Promise(function(n,i){t.then(function(t){var i=JSON.parse(t.Text);n(i)}).catch(function(){console.log("error in GetInspections");i(null)})})}function f(t){var i=XHR.Post("API/NewInspection/",JSON.stringify(t));return new Promise(function(r,u){i.then(function(i){var u=JSON.parse(i.Text);n.UI.GetInspList(t.PermitNo);r(u)}).catch(function(){console.log("error in SaveInspections");n.UI.GetInspList(t.PermitNo);u(null)})})}function e(){return""}function o(n,t){var i=XHR.Delete("API/Inspection/"+t+"/"+n);return new Promise(function(n,t){i.then(function(t){var i=JSON.parse(t.Text);n(i)}).catch(function(){console.log("error in GetInspections");t(null)})})}t.GetPermit=i;t.GetInspType=r;t.GetInspections=u;t.SaveInspection=f;t.SaveInspectionResult=e;t.CancelInspection=o})(t=n.transport||(n.transport={}))}(InspSched||(InspSched={}));
/*!
